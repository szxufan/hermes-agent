...
export interface Translations {
  ...
  kanban: {
    ...
    complete: string;
    archive: string;
    confirmBulkDone: string;
    confirmBulkArchive: string;
    reassign: string;
    unassign: string;
    apply: string;
    unassigned: string;
    createTaskInColumn: string;
    noTasks: string;
    selectForBulk: string;
    childTasksDone: string;
    untitled: string;
    roughIdea: string;
    newTaskTitle: string;
    specifier: string;
  ...
  examplePage: {
    ...
    sdkComponentsDesc: string;
    sdkApi: string;
    sdkApiDesc: string;
    sdkUtils: string;
    sdkUtilsDesc: string;
    sessionsBanner: string;
    sessionsBannerSlot: string;
  };
}
